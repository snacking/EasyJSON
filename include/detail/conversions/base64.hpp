...
static std::string decode(String const& encoded_string, bool remove_linebreaks) {
    ...
    while (pos < length_of_string) {
       ...
       size_t pos_of_char_1 = base64_lookup[encoded_string.at(pos + 1)];

       ret.push_back(static_cast<std::string::value_type>( ( (base64_lookup[encoded_string.at(pos + 0)] ) << 2 ) + ( (pos_of_char_1 & 0x30 ) >> 4)));
       ...
       {
          unsigned int pos_of_char_2 = base64_lookup[encoded_string.at(pos + 2) ];
          ...
          {
             ret.push_back(static_cast<std::string::value_type>(((pos_of_char_2 & 0x03) << 6 ) + base64_lookup[encoded_string.at(pos + 3)]));
          }
       }
